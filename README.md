...
<root>
  ...
  ├── Editor
  │   ├── QuickEye.SimpleTreeView.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── QuickEye.SimpleTreeView.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── QuickEye.SimpleTreeView.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── QuickEye.SimpleTreeView.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `QuickEye.SimpleTreeView`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package SimpleTreeView Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/QuickEye.SimpleTreeView.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/QuickEye.SimpleTreeView.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/QuickEye.SimpleTreeView.Editor.Tests.asmdef`

  `Tests/Runtime/QuickEye.SimpleTreeView.Tests.asmdef`
